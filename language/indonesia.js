...
Arigatou Gozaimasu! Untuk kalian user ramah dan Beberapa orang yg ikut membantu juga dalam project pembuatan мασυвσт
😖🙏
`
}
exports.welcome = () =>{
...
exports.leave = () =>{
	return`Yah συт ραℓιηg тαкυт ∂ι мαяαнιη εмαк α∂α вσкερ үα ∂ι gяυρ >.<
sℓмαт тιηggαℓ мσgα εмαк ℓυ тαυ`
}
exports.source = () =>{
return`*------「 SOURCE CODE 」 ------*

Base : https://github.com/DikaArdnt/Hisoka-Morou
Recode : wa.me/+6285706735450
`
}
...
Hai кι∂s
Kalian bisa mendukung saya agaя вιsα вυαт vcs
